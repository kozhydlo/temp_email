...
def check_mail(mail=''):
    ...
    if length == 0:
        print('[INFO] На електронній пошті наразі немає нових повідомлень. Перевірка відбувається автоматично кожні 5 секунд.')
    else:
        id_list = []
        ...
        print(f'[+] У вас {length} вхідних! Пошта оновлюється автоматично кожні 5 секунд!')
...
def delete_mail(mail=''):
    ...
    print(f'[X] Поштова адреса {mail} - Видалений !\n')
...
def main():
    try:
        ...
        print(f'[+] Ваша поштова адреса: {mail}')
